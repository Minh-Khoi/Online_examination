        ...
        <div class="control-group">
          ...
          <div class="controls">
            <select
              ...
              id="question_id"
              size="10"
              v-model="current_answer.question_id"
            >
              <option
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <textarea
              ...
              placeholder="Content"
              class="span8"
              v-model="current_answer.answer_content"
            ></textarea>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      questions_list: [],
      question_selected: {},
      current_answer: this.$route.params.answer
    };
  },
  ...
  methods: {
    ...
    async onSummit() {
      ...
      form_datas.append("id", this.current_answer.id);
